...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting whereCompanyName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting wherePhone($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting wherePhoneTwo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting whereLogo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting whereAddress($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<GenerelSetting>|GenerelSetting query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class GenerelSetting extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property int|null $exam_duration
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereResponsibilities($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereDepartment($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost wherePositionType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereExperienceLevel($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereSalaryRangeMin($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereSalaryRangeMax($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereLocation($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereApplicationDeadline($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereVacancies($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereIsRemote($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost wherePublishedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereExamId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereExamDuration($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost wherePassingScore($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereCreatedBy($value)
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereUpdatedBy($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<JobPost>|JobPost whereDeletedAt($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<User>|User whereCandidateId($value)
