...
<div class="container-fluid">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-1"><i class="fas fa-asterisk"></i> All Expense Category List</h4>
            </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-sm table-bordered" id="expense-category-table" width="100%" cellspacing="0">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="partModalLabel">Add New Expense category</h5>
            ...
            <form id="serviceForm" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="saveBtn">Save Expense Category</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    $('#expense-sidebar').addClass('active');
    $('#expense-category-index-sidebar').addClass('active');
    ...
    $(document).ready(function() {
        ...
        var table = $('#expense-category-table').DataTable({
            ...
            language: {
                ...
                zeroRecords: "No expense-category found",
                info: "Showing _START_ to _END_ of _TOTAL_ expense-category",
                infoEmpty: "No expense-category available",
                infoFiltered: "(filtered from _MAX_ total expense-category)",
                paginate: {
                    first: "First",
                    last: "Last",
                    next: "Next",
        ...
        // Add New Expense Category button click
        $('#addNewPart').click(function() {
            resetForm();
            $('#partModalLabel').text('Add New Expense Category');
            $('#serviceForm').attr('action', '{{ route("admin.expense-categories.store") }}');
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $.ajax({
                url: "{{ url('admin/expense-categories') }}/" + id + "/edit",
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    Swal.close();

                    $('#partModalLabel').text('Edit Expense Category');
                    $('#serviceForm').attr('action', '{{ url("admin/expense-categories") }}/' + id);
                ...
                error: function(xhr) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error!',
                        text: 'Failed to load expense category data',
        ...
        $(document).on('click', '.delete-btn', function() {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: "{{ url('admin/expense-categories') }}/" + id,
                        type: 'DELETE',
                        data: {
                            _token: "{{ csrf_token() }}"
                        }
