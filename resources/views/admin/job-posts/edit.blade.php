                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror"
                                          ...
                                          placeholder="Describe the job role, expectations, and company culture...">{{ old('description', $jobPost->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('requirements') is-invalid @enderror"
                                          ...
                                          placeholder="List the required skills, qualifications, and experience...">{{ old('requirements', $jobPost->requirements) }}</textarea>
                                @error('requirements')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('responsibilities') is-invalid @enderror"
                                          ...
                                          placeholder="Describe the key responsibilities and duties...">{{ old('responsibilities', $jobPost->responsibilities) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <select required name="department" id="" class="form-control">
                                    ...
                                    @foreach ($departments as $department)
                                        <option
                                        @if ($jobPost->department == $department->id)
                                            selected
                                        @endif
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control @error('position_type') is-invalid @enderror"
                                    ...
                                    <option value="full-time" {{ old('position_type', $jobPost->position_type) == 'full-time' ? 'selected' : '' }}>Full Time</option>
                                    <option value="part-time" {{ old('position_type', $jobPost->position_type) == 'part-time' ? 'selected' : '' }}>Part Time</option>
                                    <option value="contract" {{ old('position_type', $jobPost->position_type) == 'contract' ? 'selected' : '' }}>Contract</option>
                                    <option value="remote" {{ old('position_type', $jobPost->position_type) == 'remote' ? 'selected' : '' }}>Remote</option>
                                </select>
                                @error('position_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-control @error('experience_level') is-invalid @enderror"
                                    ...
                                    <option value="mid" {{ old('experience_level', $jobPost->experience_level) == 'mid' ? 'selected' : '' }}>Mid Level</option>
                                    <option value="senior" {{ old('experience_level', $jobPost->experience_level) == 'senior' ? 'selected' : '' }}>Senior Level</option>
                                    <option value="executive" {{ old('experience_level', $jobPost->experience_level) == 'executive' ? 'selected' : '' }}>Executive</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('salary_range_min') is-invalid @enderror"
                                           id="salary_range_min" name="salary_range_min"
                                           value="{{ old('salary_range_min', $jobPost->salary_range_min) }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('salary_range_max') is-invalid @enderror"
                                           id="salary_range_max" name="salary_range_max"
                                           value="{{ old('salary_range_max', $jobPost->salary_range_max) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" class="form-control @error('application_deadline') is-invalid @enderror"
                                       ...
                                       value="{{ old('application_deadline', $jobPost->application_deadline ? \Carbon\Carbon::parse($jobPost->application_deadline)->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('vacancies') is-invalid @enderror"
                                       ...
                                       value="{{ old('vacancies', $jobPost->vacancies) }}" min="1">
                                @error('vacancies')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('exam_id') is-invalid @enderror"
                                       ...
                                       value="{{ old('exam_id', $jobPost->exam_id) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('exam_duration') is-invalid @enderror"
                                       ...
                                       value="{{ old('exam_duration', $jobPost->exam_duration) }}"
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('passing_score') is-invalid @enderror"
                                       ...
                                       value="{{ old('passing_score', $jobPost->passing_score) }}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                                    ...
                                    <option value="published" {{ old('status', $jobPost->status) == 'published' ? 'selected' : '' }}>Published</option>
...
$(document).ready(function() {
    ...
    $('#is_remote').change(function() {
        if ($(this).is(':checked')) {
            ...
            $('#location').val('{{ old('location', $jobPost->location) }}').prop('readonly', false);
        }
    });
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            // Other errors
                            let errorMessage = 'An error occurred while updating the job post. Please try again.';
