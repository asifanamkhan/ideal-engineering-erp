...
<div class="container-fluid">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-1"><i class="fas fa-asterisk"></i> All Service List</h4>
            </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-sm table-bordered" id="services-table" width="100%" cellspacing="0">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="partModalLabel">Add New Service</h5>
...
<script>
    ...
    $('#services-index-sidebar').addClass('active');
    ...
    $(document).ready(function() {
        ...
        $('#addNewPart').click(function() {
            resetForm();
            $('#partModalLabel').text('Add New Service');
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#partModalLabel').text('Edit Service');
                    $('#serviceForm').attr('action', '{{ url("admin/services") }}/' + id);
