...
<div class="container-fluid">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-1"><i class="fas fa-asterisk"></i> All Unit List</h4>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="partModalLabel">Add New Unit</h5>
            ...
            <form id="serviceForm" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="saveBtn">Save Unit</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $('#units-index-sidebar').addClass('active');
    ...
    $(document).ready(function() {
        ...
        // Add New Unit button click
        $('#addNewPart').click(function() {
            resetForm();
            $('#partModalLabel').text('Add New Unit');
            $('#serviceForm').attr('action', '{{ route("admin.units.store") }}');
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#partModalLabel').text('Edit Unit');
                    $('#serviceForm').attr('action', '{{ url("admin/units") }}/' + id);
