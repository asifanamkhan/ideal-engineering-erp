...
<div class="container-fluid">
    <div class="page-header">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h4 class="mb-1"><i class="fas fa-asterisk"></i> All Size List</h4>
            </div>
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-sm table-bordered" id="sizes-table" width="100%" cellspacing="0">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="partModalLabel">Add New Size</h5>
            ...
            <form id="serviceForm" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="saveBtn">Save Size</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $('#sizes-index-sidebar').addClass('active');
    ...
    $(document).ready(function() {
        ...
        var table = $('#sizes-table').DataTable({
            ...
            language: {
                ...
                zeroRecords: "No sizes found",
                info: "Showing _START_ to _END_ of _TOTAL_ sizes",
                infoEmpty: "No sizes available",
                infoFiltered: "(filtered from _MAX_ total sizes)",
                paginate: {
                    first: "First",
                    last: "Last",
                    next: "Next",
        ...
        // Add New Size button click
        $('#addNewPart').click(function() {
            resetForm();
            $('#partModalLabel').text('Add New Size');
            $('#serviceForm').attr('action', '{{ route("admin.sizes.store") }}');
        ...
        $(document).on('click', '.edit-btn', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#partModalLabel').text('Edit Size');
                    $('#serviceForm').attr('action', '{{ url("admin/sizes") }}/' + id);
