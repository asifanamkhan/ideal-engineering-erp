        ...
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="reference" name="reference"
                    placeholder="Reference person/company">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group mb-3">
                ...
                <input type="number" step="0.01" class="form-control" id="opening_bal" name="opening_bal" value="0"
                    placeholder="0.00">
            </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="tax_no" name="tax_no" placeholder="GST/VAT number">
                </div>
            </div>
        </div>
