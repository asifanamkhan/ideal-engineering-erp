...
<div class="container-fluid">
    ...
    <form id="invoiceForm">
                    ...
                    <div class="job-info-card p-3 mt-3 rounded">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-3 text-end" id="printBtnContainer" style="display: none;">
                                <button type="button" class="btn btn-info btn-sm" id="printInvoiceBtn">
        ...
        <!-- Invoice Form -->
        <div class="card shadow mt-4" id="invoiceFormCard" style="display: none;">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
        ...
        <div class="card shadow mt-4" id="servicesCard" style="display: none;">
                        ...
                        <tfoot class="table-calculations">
                            ...
                            <tr>
                                ...
                                <td class="fw-bold" style="text-align: right">
                                    <input type="number" step="0.01" name="invoice_discount" id="invoice_discount" class="form-control form-control-sm"
                                    value="0" placeholder="Enter discount amount" style="width: 120px;">
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="5" class="text-end fw-bold bg-light">Total:</td>
                                <td class="fw-bold bg-light" style="text-align: right" id="totalAmount">0.00</td>
                                <td></td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <div class="mt-4 mb-4 text-center">
                ...
                <button onclick="return confirm('Are you sure you want to save this invoice?')" type="button" id="saveInvoiceBtn" class="btn btn-lg btn-success px-4">
...
<script>
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#job_id').append(newOption).trigger('change');
                ...
                error: function(xhr) {
                    $('#job_id').empty().append(new Option('Error loading job', '', true, true));
                    Swal.fire('Error', 'Failed to load job details. Please try again.', 'error');
                }
            });
        }
        ...
        // Load Job Details and Existing Invoice
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        if (response.job.invoice_date || response.job.invoice_description) {
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
                            ...
                            // window.location.href = "{{ route('admin.job-invoices.create') }}";
                        });
                    } else {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success && response.service) {
                        ...
                        Swal.fire('Error!', response.message || 'Failed to add service', 'error');
                    }
                },
                error: function(xhr) {
                    var errorMsg = 'Failed to add service';
                    if (xhr.responseJSON && xhr.responseJSON.message) {
                        errorMsg = xhr.responseJSON.message;
                    }
                    Swal.fire('Error!', errorMsg, 'error');
