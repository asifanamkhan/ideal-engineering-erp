...
class RolesController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($roles)
                ...
                ->addColumn('action', function ($role) {
                    return view('admin.user-management.roles.partials.action-btn-view', [
                        'id' => $role->id,
                        'name' => $role->name
                    ])->render();
                })
    ...
    public function create()
    {
        ...
        return view('admin.user-management.roles.create', compact('modules'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.user-management.roles.edit', compact('role', 'modules', 'rolePermissions'));
    }
